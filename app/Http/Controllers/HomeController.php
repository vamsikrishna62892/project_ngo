...
class HomeController extends Controller
{
    ...
    {
        //stats
        $users_count = 0;#User::where('is_admin',0)->where('is_Volunteer',0)->where('is_Counsellor',0)->count();
        $gallery_count = 0;#Gallery::all()->count();
        ...
        return view('admin.dashboard_admin',compact('users_count','shared_news','newsarticle','admin_name','gallery_count'));
    }
