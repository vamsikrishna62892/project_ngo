...
<body>
    ...
    <div class="offcanvas-menu">
        ...
        <div class="offcanvas__widget">
            ...
            <a href="{{ route('register') }}" class="primary-btn">Donate</a>
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="header__top__widget">
                            @guest
                                ...
                                <a style="text-decoration: none" href="{{ route('login') }}" class="primary-btn">Donate</a>
                                @if (Route::has('register'))
                    ...
                    <div class="col-lg-12 col-md-9" align="right">
                        <nav class="header__menu">
                            <ul>
                                ...
                                <li><a style="text-decoration: none" href="{{ url('team') }}">Team</a></li>
                            </ul>
                        </nav>
                    </div>
