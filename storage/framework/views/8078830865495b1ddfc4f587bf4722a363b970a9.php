...
<body>
    ...
    <div class="offcanvas-menu">
        ...
        <div class="offcanvas__widget">
            ...
            <a href="<?php echo e(route('register')); ?>" class="primary-btn">Donate</a>
    ...
    <header class="header">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="header__top__widget">
                            <?php if(auth()->guard()->guest()): ?>
                                ...
                                <a style="text-decoration: none" href="<?php echo e(route('login')); ?>" class="primary-btn">Donate</a>
                                <?php if(Route::has('register')): ?>
        ...
        <div class="header__nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-9" align="right">
                        <nav class="header__menu">
                            <ul>
                                ...
                                <li><a style="text-decoration: none" href="<?php echo e(url('team')); ?>">Team</a></li>
                            </ul>
                        </nav>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\project_ngo\resources\views/layouts/layout.blade.php ENDPATH**/ ?>